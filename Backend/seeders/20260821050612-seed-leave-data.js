...
// Compatibility seeder. Leave types and yearly balances are created by the
// dedicated seeders above. This file only repairs missing current-year balances.
module.exports = {
  ...
  async down() {
    // Intentionally empty: compatibility repair only.
  },
};
